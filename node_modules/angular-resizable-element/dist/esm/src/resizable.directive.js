...
export var Resizable = (function () {
    ...
    Resizable.propDecorators = {
        ...
        'onMousedown': [{ type: HostListener, args: ['document:touchstart', ['$event.touches[0].clientX', '$event.touches[0].clientY'],] }, { type: HostListener, args: ['document:mousedown', ['$event.clientX', '$event.clientY'],] },],
        'onMousemove': [{ type: HostListener, args: ['document:touchmove', ['$event', '$event.targetTouches[0].clientX', '$event.targetTouches[0].clientY'],] }, { type: HostListener, args: ['document:mousemove', ['$event', '$event.clientX', '$event.clientY'],] },],
        'onMouseup': [{ type: HostListener, args: ['document:touchend', ['$event.changedTouches[0].clientX', '$event.changedTouches[0].clientY'],] }, { type: HostListener, args: ['document:touchcancel', ['$event.changedTouches[0].clientX', '$event.changedTouches[0].clientY'],] }, { type: HostListener, args: ['document:mouseup', ['$event.clientX', '$event.clientY'],] },],
    };
    return Resizable;
}());

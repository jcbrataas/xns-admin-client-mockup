...
/***/ function(module, exports, __webpack_require__) {
	...
	var resizeHandle_directive_1 = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Resizable = (function () {
	    ...
	    __decorate([
	        core_1.HostListener('document:touchstart', ['$event.touches[0].clientX', '$event.touches[0].clientY']),
	    ...
	    __decorate([
	        core_1.HostListener('document:touchmove', ['$event', '$event.targetTouches[0].clientX', '$event.targetTouches[0].clientY']),
	        core_1.HostListener('document:mousemove', ['$event', '$event.clientX', '$event.clientY']), 
	        __metadata('design:type', Function), 
	        __metadata('design:paramtypes', [MouseEvent, Number, Number]), 
	        __metadata('design:returntype', void 0)
	    ], Resizable.prototype, "onMousemove", null);
	    __decorate([
	        core_1.HostListener('document:touchend', ['$event.changedTouches[0].clientX', '$event.changedTouches[0].clientY']),
	        core_1.HostListener('document:touchcancel', ['$event.changedTouches[0].clientX', '$event.changedTouches[0].clientY']),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResizeHandle = (function () {
	    ...
	    __decorate([
	        core_1.HostListener('touchmove', ['$event', '$event.targetTouches[0].clientX', '$event.targetTouches[0].clientY']),
	        core_1.HostListener('mousemove', ['$event', '$event.clientX', '$event.clientY']), 
	        __metadata('design:type', Function), 
	        __metadata('design:paramtypes', [MouseEvent, Number, Number]), 
	        __metadata('design:returntype', void 0)
